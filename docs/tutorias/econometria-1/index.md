...
<a href="tutores/tutor5/" style="display:block;background:#fff;border:1px solid #e0e0e0;border-left:4px solid #D71920;border-radius:6px;padding:14px 16px;text-decoration:none;color:#222;font-weight:600;font-size:0.9rem;box-shadow:2px 2px 5px rgba(0,0,0,0.06);">Luis Pizarro<div style="color:#D71920;font-size:0.75rem;font-weight:400;margin-top:5px;">Ver perfil →</div></a>
